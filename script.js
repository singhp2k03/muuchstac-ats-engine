...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Custom SVGs mapping to your screenshots
    ...
    // Check if the user already selected Dark Mode previously
    ...
    if (form) {
        form.addEventListener('submit', async function(event) {
            ...
            try {
                ...
                const svgDoc = `<svg width="13" height="13" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="margin-right:4px; vertical-align:text-bottom;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>`;
                    ...
                    data.forEach((candidate, index) => {
                        ...
                        tr.innerHTML = `
                            <td>
                                ...
                                <div class="candidate-filename">${svgDoc} ${candidate.source_file}</div>
                            ...
                            <td><strong>${candidate.experience_score}</strong><span class="score-muted">/30</span></td>
                            ...
                            <td>
                                <strong>${candidate.location_score}</strong><span class="score-muted">/10</span><br>
    ...
    modalBody.innerHTML = `
        ...
        <div class="dashboard-grid">
            <div class="dashboard-card">
                ...
                <p>${iconExp}<strong>Experience:</strong> ${cand.experience_score}/30 (${cand.experience_years} years detected)</p>
                <p>${iconSkills}<strong>Skills:</strong> ${cand.skills_score}/30</p>
                <p>${iconEdu}<strong>Education:</strong> ${cand.education_score}/30</p>
                <p>${iconLocation}<strong>Location:</strong> ${cand.location_score}/10</p>
            </div>
